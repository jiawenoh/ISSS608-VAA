...
pacman::p_load(jsonlite, tidygraph, ggraph, visNetwork, 
              tidytext, tidyverse, RColorBrewer, wordcloud2,DT,
               treemap,knitr,ggiraph,hrbrthemes,scales,igraph,devtools)
...
The `d3tree` function from the `[d3treeR]` package is used to build our interactive treemap.

```{r}
d3tree(e5, rootname = "Categories by Country")
